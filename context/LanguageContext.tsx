...
const translations = {
  ar: {
    ...
    'confirm_save_before_nav': 'توجد تغييرات غير محفوظة. هل تريد حفظها قبل الانتقال؟'
  },
  fr: {
    ...
    'confirm_save_before_nav': 'Des modifications non enregistrées existent. Voulez-vous les enregistrer avant de naviguer ?'
  }
};
