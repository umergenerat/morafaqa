            ...
            <div key={user.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col justify-between hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-1">
                  ...
                  {user.id !== currentUser.id && user.id !== 'admin_main' && (
                ...
                {formData.role === UserRole.PARENT && (
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 mt-2">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full font-bold ${
                          (formData.linkedStudentIds?.length || 0) > 0 ? 'bg-blue-100 text-blue-700' : 'bg-gray-200 text-gray-500'
                      }`}>
                        ...
                        filteredStudentsToLink.map(student => {
                          ...
                          return (
                            <div key={student.id} 
                              ...
                              className={`flex items-center gap-3 p-2 rounded-xl border cursor-pointer transition-all relative overflow-hidden ${
                                isSelected 
