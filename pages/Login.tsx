...
import { Lock, Mail, GraduationCap, ArrowRight, Languages, AlertCircle, Eye, EyeOff, User, Loader2 } from 'lucide-react';

const Login: React.FC = () => {
  const { users, login, schoolSettings, isLoading: isGlobalLoading } = useData();
