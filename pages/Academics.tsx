...
const Academics: React.FC = () => {
  ...
  const isAdminOrTeacher = [UserRole.ADMIN, UserRole.TEACHER, UserRole.SUPERVISOR].includes(currentUser.role);
         ...
         {filteredRecords.length === 0 ? (
           <div className="col-span-full py-16 text-center bg-white rounded-2xl border border-dashed border-gray-300">
             ...
             <p className="text-gray-400 font-medium">
               {isParent && (!currentUser.linkedStudentIds || currentUser.linkedStudentIds.length === 0) 
